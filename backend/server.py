...
from backend import color_to_grey
...
class MainApplication(web.Application):
    ...
    def __init__(self, **settings):
        ...
        self.add_handlers(".*", [
            ...
            (r"/img/(.*)", web.StaticFileHandler, {"path": STATIC_IMG_FOLDER}),
            (r".*/static/(.*)", web.StaticFileHandler, {"path": STATIC_FOLDER})
        ])
...
if __name__ == "__main__":
    ...
    options.define('port', default=80, help='Port to listen on.')
